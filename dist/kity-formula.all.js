/*!
 * ====================================================
 * Kity Formula - v1.0.0 - 2014-04-14
...
define("control/location", [ "kity" ], function(require, exports, module) {
    ...
    return kity.createClass("LocationComponent", {
        ...
        updateCursorInfo: function(evt) {
            var cursorInfo = null, groupInfo = this.kfEditor.requestService("position.get.group", evt.target), index = -1;
            if (groupInfo === null) {
        ...
        updateCursor: function() {
            var cursorInfo = this.kfEditor.requestService("syntax.get.record.cursor"), groupInfo = this.kfEditor.requestService("syntax.get.group.content", cursorInfo.groupId), isBefore = cursorInfo.endOffset === 0, index = isBefore ? 0 : cursorInfo.endOffset - 1, focusChild = groupInfo.content[index], paperContainerRect = getRect(this.paper.container.node), cursorOffset = 0, focusChildRect = getRect(focusChild), cursorTransform = this.cursorShape.getTransform(), canvasZoom = this.kfEditor.requestService("render.get.canvas.zoom"), formulaZoom = this.paper.getZoom();
...
define("control/selection", [ "kity", "base/utils", "base/common", "base/event/event" ], function(require, exports, module) {
    ...
    return kity.createClass("SelectionComponent", {
        ...
        updateSelectionByTarget: function(target) {
            var groupInfo = this.kfEditor.requestService("position.get.group", target), cursorInfo = {};
            if (groupInfo === null) {
                return;
            }
            // 更新光标信息
...
define("parse/parser", [ "kf", "kity", "parse/def", "kf-ext/extension", "kf-ext/def", "kf-ext/expression/placeholder" ], function(require) {
    var KFParser = require("kf").Parser, kity = require("kity"), COMPARISON_TABLE = require("parse/def"), COMBINATION_NAME = "combination", PID_PREFIX = "_kf_editor_", GROUP_TYPE = "kf-editor-group", V_GROUP_TYPE = "kf-editor-virtual-group", PID = 0;
...
define("render/render", [ "kity", "kf" ], function(require) {
    var kity = require("kity"), Assembly = require("kf").Assembly, DEFAULT_OPTIONS = {
        ...
        tintCurrentGroup: function() {
            var groupId = this.kfEditor.requestService("syntax.get.record.cursor").groupId, groupObject = this.kfEditor.requestService("syntax.get.group.object", groupId), isPlaceholder = this.kfEditor.requestService("syntax.valid.placeholder", groupId);
            this.clearSelect();
            if (groupObject.node.getAttribute("data-root")) {
                // 根节点不着色
                return;
